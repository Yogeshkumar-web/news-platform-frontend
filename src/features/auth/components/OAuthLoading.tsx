...
export function OAuthLoading({
    ...
    return (
        <div
            className={cn(
                "flex flex-col items-center justify-center p-8 bg-blue-50 border-2 border-blue-200 rounded-lg",
        ...
        >
            ...
            <div className="relative mb-6">
                ...
                {/* Inner dot */}
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-3 h-3 bg-blue-600 rounded-full animate-pulse" />
            </div>
            ...
            {/* Security Note */}
            <div className="mt-6 flex items-start gap-2 text-xs text-blue-600 bg-blue-100 px-3 py-2 rounded-md">
                <svg
        ...
        <div className="flex items-center gap-3">
            ...
            <div
                className={cn(
                    ...
                    isActive && !isComplete && "bg-blue-500 animate-pulse",
            ...
            <span
                className={cn(
                    ...
                    isActive && !isComplete && "text-blue-700 font-medium",
