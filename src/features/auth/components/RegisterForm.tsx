    ...
    return (
        <form action={handleSubmit} className='space-y-6'>
            ...
            <p className='text-center text-sm text-gray-600'>
                ...
                <Link
                    href='/login'
                    className='text-[#d95353] hover:text-[#b83f3f] font-medium'
                >
                    Login here
                </Link>
            </p>
...
function SubmitButton() {
    ...
    return (
        <button
            type='submit'
            disabled={pending}
            className='w-full px-4 py-2 bg-[#d95353] text-white font-medium rounded-lg hover:bg-[#b83f3f] disabled:opacity-50 disabled:cursor-not-allowed transition-colors'
        >
