        ...
        return (
            <div className='bg-gray-50 border border-gray-200 rounded-lg p-6 text-center'>
                ...
                <Link
                    ...
                    className='inline-block px-6 py-2 bg-[#d95353] text-white rounded-lg hover:bg-[#b83f3f]'
                >
                    Login
                </Link>
            </div>
        ...
        <form action={handleSubmit} className='space-y-4'>
            ...
            <div>
                <textarea
                    ...
                    minLength={3}
                    maxLength={1000}
                    className='w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#fff5f5]0 focus:border-transparent resize-none'
                />
...
function SubmitButton({ isValid }: { isValid: boolean }) {
    ...
    return (
        <button
            ...
            className='px-6 py-2 bg-[#d95353] text-white font-medium rounded-lg hover:bg-[#b83f3f] disabled:opacity-50 disabled:cursor-not-allowed transition-colors'
        >
