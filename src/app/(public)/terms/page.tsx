                ...
                <div className="border-t-4 border-gray-950 bg-white p-4 md:p-10">
                    ...
                    <div className="prose prose-lg max-w-none text-gray-600">
                        ...
                        <section className="mb-8">
                            ...
                            <p>
                                By accessing our website at {BRAND.name}, you agree to be bound by these terms of service, all applicable laws and regulations,
                        ...
                        <section className="mb-8">
                            ...
                            <p>
                                Permission is granted to temporarily download one copy of the materials (information or software) on {BRAND.name}&apos;s website for personal,
                        ...
                        <section className="mb-8">
                            ...
                            <p>
                                The materials on {BRAND.name}&apos;s website are provided on an &apos;as is&apos; basis. {BRAND.name} makes no warranties, expressed or implied,
                        ...
                        <section className="mb-8">
                            ...
                            <p>
                                ...
                                or due to business interruption) arising out of the use or inability to use the materials on {BRAND.name}&apos;s website, even if {BRAND.name}
